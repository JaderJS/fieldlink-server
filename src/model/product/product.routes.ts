...
import { balanceProducts, createCategory, getPurchase, upsertPurchase, getCategoryInProducts, getProduct, getProducts, getSuppliers, updateProduct, upsertProduct, getPurchases, deletePurchase } from "@/model/product/product.controller"
import { getOrders, getOrder, upsertOrder, deleteOrder } from "./order.controller"
